...
SEQUENCE="WUP_GoFast_Gen6-20231010T121645Z053__20231010T121656Z189_20231010T121708Z389"
...
BAG_BASE_PATH="${BAG_LOCATION}/Aptiv" #Change this to the directory where you have the bag files
...
EVAL_BASE_DIR="${BAG_LOCATION}/Cfear/Aptiv/${SEQUENCE}"
